...
class Window:
    def __init__(self, master, chatbot):
        ...
        # Submit button
        self.submit_button = tk.Button(self.frame, text="Submit", command=self.submit_input)
        self.submit_button.pack(pady=5)

        # Idea button
        self.idea_button = tk.Button(self.frame, text="Get Idea", command=self.idea_input)
